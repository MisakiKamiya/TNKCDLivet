...
{
    public class TNKCDCreateViewModel : ViewModel
    {
        /* コマンド、プロパティの定義にはそれぞれ 
         * 
        ...
        public TNKCD TNKCD
        {
            ...
            { 
                if (_TNKCD == value)
                    return;
                _TNKCD = value;
                RaisePropertyChanged(nameof(TNKCD));
            }
        }
        #endregion
        ...
        private Employee _EmployeeP;

        public Employee EmployeeP
        {
            get
            { return _EmployeeP; }
            set
            { 
                if (_EmployeeP == value)
                    return;
                _EmployeeP = value;
                RaisePropertyChanged(nameof(EmployeeP));
            }
        }
        #endregion
        ...
        public Work WorkP
        {
            ...
            { 
                if (_WorkP == value)
                    return;
                _WorkP = value;
                RaisePropertyChanged(nameof(WorkP));
            }
        }
